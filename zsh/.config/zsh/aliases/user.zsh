...
alias cht='cht.sh'
alias chmox='chmod +x'
alias clipboard='fzf-clipboard'
alias clock='tty-clock'
alias colorpicker='hyprpicker'
alias khard='env PYTHONWARNINGS="ignore::DeprecationWarning" khard'
alias contact='env PYTHONWARNINGS="ignore::DeprecationWarning" khard'
alias contacts='env PYTHONWARNINGS="ignore::DeprecationWarning" khard'
alias dirsize='du'
alias email='neomutt'
...
alias img='swayimg'
alias keymap='img "$XDG_DATA_HOME/keymap.png"'
#alias lf='$HOME/.config/lf/lfrun'
alias lock='hyprlock'
alias lynx='lynx -vikeys -accept_all_cookies'
alias mail='neomutt'
# alias man='man $1 | col -bx | bat -l man -p'
...
alias screenrecord='wf-recorder'
alias screenrecord-region='wf-recorder -g "$(slurp)"'
alias sunset='hyprsunset'
alias tvim='nvim -c "terminal $SHELL" -c "startinsert" -c "autocmd TermClose * qa"'
alias unzipall="fd -e zip -X unzip {} \;"
alias weather='curl -L wttr.in/Vienna'
alias webcam-record='ffmpeg -f v4l2 -i /dev/video0 -f pulse -i default -c:v libx264 -preset veryfast -c:a aac webcam.mp4'
